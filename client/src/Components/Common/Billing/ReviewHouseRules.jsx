...
import { Breadcrumb, Container, Row, Col, InputGroup, FormControl, Button } from 'react-bootstrap'
            ...
            <Container>
                ...
                <Row>
                    <Col md={8} className="pl-5">
                        ...
                        <h6 className="mt-5">
                            2 nights in Puducherry
                        </h6>
                        <Row>
                            <Col className="d-flex align-items-center">

                                <span className={styles.dayWrapper}><span>JUL</span><span>31</span> </span>
                        ...
                        <Row>
                            <Col><img src={key} alt="" /> Self check-in with building staff </Col>
                        </Row>
                        ...
                        <Row className="my-2">
                            <Col><img className={styles.icon} src={children} alt="" /><span className={styles.keepInMindText}>
                                Suitable for children and infants</span>
                            </Col>

                        </Row>
                        <Row className="my-2">
                            <Col><img className={styles.icon} src={animal} alt="" /><span className={styles.keepInMindText}>
                                Pets allowed</span>
                            </Col>

                        </Row>
                        <Row className="my-2">
                            <Col><img className={styles.icon} src={smoking} alt="" /><span className={styles.keepInMindText}>
                                Smoking allowed</span>
                            </Col>

                        </Row>
                        <Row className="my-2">
                            <Col><img className={styles.icon} src={parking} alt="" /><span className={styles.keepInMindText}>
                                No parking on property</span></Col>
