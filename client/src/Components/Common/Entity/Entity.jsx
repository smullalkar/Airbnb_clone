...
class Entity extends Component {
  ...
  componentDidMount() {
    const { getData, getBookedDates, getHostInfo } = this.props;
    ...
    getHostInfo({ property_id: Number(newQuery) });
  ...
  componentDidUpdate(prevProps, prevState) {
    const { data, bookedDates, getRecommendation } = this.props;
    ...
    if (prevState.home.length === 0) {
      ...
      query.forEach((item) => {
        ...
        if (param[0] === "location") obj.location = param[1];
      });
            ...
            <div className="d-flex flex-row justify-content-between">
              <div>
                <h3 className={styles.listingName}>
                  Entire cabin hosted by Sharan Deep Singh
                </h3>
                <div
              ...
              <div className="d-flex flex-row justify-content-start">
                ...
                <div>
                  <h6 className={styles.detailHeading}>
                    Sharan Deep Singh is a Superhost
                  </h6>
                  <p className={styles.detailDescription}>
